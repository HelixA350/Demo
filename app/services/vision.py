            ...
            content=[
                {
                    "type": "text",
                    "text": (
                        "Кратко опиши изображение для поиска по базе знаний. "
                        "Включи: 1) весь видимый текст дословно (надписи, заголовки, подписи, цифры, таблицы, коды); "
                        "2) тип документа или объекта если понятен; "
                        "3) ключевые визуальные элементы. "
                        "Ответ — сплошной текст без форматирования, максимум 200 слов."
                    ),
                },
                {
                    "type": "image_url",
